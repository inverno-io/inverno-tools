...
public class StopMojo extends AbstractWinterMojo {

	/**
	 * Skips the execution.
	 */
	@Parameter(property = "winter.stop.skip", required = false)
	private boolean skip;
	
	/**
	 * The amount of time in milliseconds to wait for the application to stop.
	 */
	@Parameter(property = "winter.stop.timeout", defaultValue = "60000", required = false)
	...
	public void doExecute() throws MojoExecutionException, MojoFailureException {
			...
			ProjectModule projectModule = new ProjectModule(this.project, projectModuleReference.descriptor(), Set.of(), this.winterBuildPath, this.jmodsPath, ProjectModule.Classifier.RUNTIME, Set.of());
