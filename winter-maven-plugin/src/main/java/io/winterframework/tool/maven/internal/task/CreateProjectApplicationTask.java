...
public class CreateProjectApplicationTask extends Task<Void> {
	...
	protected Void execute() throws TaskExecutionException {
		if(this.projectModule.isMarked() || 
			...
			try {
				...
				throw new TaskExecutionException("Error creating project application, activate '-Dwinter.verbose=true' to display full log", e);
			}
		}
		else {
			if(this.verbose) {
	...
	public static class LinuxConfiguration {
		 ...
		 */
		@Parameter(property = "winter.app.linux.packageName", required = false)
		private String packageName;
		
		/**
		 * Maintainer for .deb bundle.
		 */
		@Parameter(property = "winter.app.linux.debMaintainer", required = false)
		private String debMaintainer;
		
		/**
		 * Menu group this application is placed in.
		 */
		@Parameter(property = "winter.app.linux.menuGroup", required = false)
		private String menuGroup;

		/**
		 * Required packages or capabilities for the application.
		 */
		@Parameter(property = "winter.app.linux.packageDeps", required = false)
		private String packageDeps;

		/**
		 * Type of the license ("License: {@literal <value>} of the RPM .spec).
		 */
		@Parameter(property = "winter.app.linux.rpmLicenseType", required = false)
		private String rpmLicenseType;

		/**
		 * Release value of the RPM <name>.spec file or Debian revision value of the DEB control file.
		 */
		@Parameter(property = "winter.app.linux.appRelease", required = false)
		private String appRelease;
		
		/**
		 * Group value of the RPM <name>.spec file or Section value of DEB control file.
		 */
		@Parameter(property = "winter.app.linux.appCategory", required = false)
		private String appCategory;
		
		/**
		 * Creates a shortcut for the application
		 */
		@Parameter(property = "winter.app.linux.shortcut", required = false)
	...
	public static class MacOSConfiguration {
		 ...
		 */
		@Parameter(property = "winter.app.macos.packageIdentifier", required = false)
		 ...
		 */
		@Parameter(property = "winter.app.macos.packageName", required = false)
		private String packageName;
		 ...
		 */
		@Parameter(property = "winter.app.macos.bundleSigningPrefix", required = false)
		private String bundleSigningPrefix;
		
		/**
		 * Request that the bundle be signed.
		 */
		@Parameter(property = "winter.app.macos.sign", required = false)
		 ...
		 */
		@Parameter(property = "winter.app.macos.signingKeychain", required = false)
	...
	public static class WindowsConfiguration {
		 ...
		 */
		@Parameter(property = "winter.app.windows.console", required = false)
		private boolean console;
		
		/**
		 * Adds a dialog to enable the user to choose a directory in which the product is installed.
		 */
		@Parameter(property = "winter.app.windows.dirChooser", required = false)
		private boolean dirChooser;
		
		/**
		 * Adds the application to the system menu.
		 */
		@Parameter(property = "winter.app.windows.menu", required = false)
		private boolean menu;
		
		/**
		 * Start Menu group this application is placed in.
		 */
		@Parameter(property = "winter.app.windows.menuGroup", required = false)
		private String menuGroup;
		
		/**
		 * Request to perform an install on a per-user basis.
		 */
		@Parameter(property = "winter.app.windows.perUserInstall", required = false)
		private boolean perUserInstall;

		/**
		 * Creates a desktop shortcut for the application.
		 */
		@Parameter(property = "winter.app.windows.shortcut", required = false)
		private boolean shortcut;
		
		/**
		 * UUID associated with upgrades for this package.
		 */
		@Parameter(property = "winter.app.windows.upgradeUUID", required = false)
