...
public class ProjectModule implements ImageModule {
	...
	private final Path winterBuildPath;
	 ...
	 * @param winterBuildPath    the winter plugin build path
	 ...
	 *                           build
	 */
	public ProjectModule(MavenProject project, ModuleDescriptor moduleDescriptor, Set<DependencyModule> moduleDependencies, Path winterBuildPath, Path jmodsPath, Classifier classifier, Set<String> formats) {
		this.project = project;
		this.moduleDescriptor = moduleDescriptor;
		this.moduleDependencies = moduleDependencies;
		this.winterBuildPath = winterBuildPath;
	...
	public Path getPidfile() {
		return this.winterBuildPath.resolve(this.getModuleName() + ".pid");
	}
	...
	public Path getRuntimeImagePath() {
		return this.winterBuildPath.resolve(Paths.get(Classifier.RUNTIME.getClassifier(), this.project.getBuild().getFinalName()));
	}
	...
	public Path getApplicationImagePath() {
		return this.winterBuildPath.resolve(Paths.get(Classifier.APPLICATION.getClassifier(), this.project.getBuild().getFinalName()));
	}
