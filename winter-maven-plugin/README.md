...
io.winterframework.tool:winter-maven-plugin:1.0.0-SNAPSHOT:build-runtime
...
io.winterframework.tool:winter-maven-plugin:1.0.0-SNAPSHOT:help

**Description:**

Display help information on winter-maven-plugin.
Call mvn winter:help -Ddetail=true -Dgoal=&lt;goal-name&gt; to display parameter details.
...
io.winterframework.tool:winter-maven-plugin:1.0.0-SNAPSHOT:run
    ...
    <tr>
        ...
        <td>
            ...
            <ul>
                <li>
                    <em>User property</em>
                    : winter.exec.configurationDirectory
                </li>
                <li>
                    <em>Default</em>
                    : ${project.basedir}/src/main/conf/
    ...
    <tr>
        ...
        <td>
            ...
            <ul>
                <li>
                    <em>User property</em>
                    : winter.exec.jmodsOverrideDirectory
                </li>
                <li>
                    <em>Default</em>
                    : ${project.basedir}/src/jmods/
    ...
    <tr>
        ...
        <td>
            ...
            <ul>
                <li>
                    <em>User property</em>
                    : winter.run.workingDirectory
                </li>
                <li>
                    <em>Default</em>
                    : ${project.build.directory}/maven-winter/working
                </li>
            </ul>
        </td>
    </tr>
...
io.winterframework.tool:winter-maven-plugin:1.0.0-SNAPSHOT:start
...
io.winterframework.tool:winter-maven-plugin:1.0.0-SNAPSHOT:stop
