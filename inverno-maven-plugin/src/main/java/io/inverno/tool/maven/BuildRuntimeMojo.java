...
import io.inverno.tool.maven.internal.task.CreateImageArchivesTask;
...
public class BuildRuntimeMojo extends AbstractImageMojo {
	 ...
	 * package.
	 */
	@Parameter(property = "inverno.runtime.projectMainClass", required = false)
	protected String projectMainClass;
	
	/**
	 * Resolve the project main class when not specified explicitly.
	 */
	@Parameter(property = "inverno.runtime.projectMainClass", defaultValue = "false", required = false)
	...
	protected void doExecute() throws MojoExecutionException, MojoFailureException {
		try {
			...
			this.projectModule = new ProjectModule(this.project, projectModuleReference.descriptor(), dependencies, this.invernoBuildPath, this.jmodsPath, ProjectModule.Classifier.RUNTIME, this.formats);
